...
const ColumnDefinitions SchoolScannerDefinities::_columnDefs =
{
	...
	new CD("In de klas worden kwetsende opmerkingen gemaakt over mijn identiteit",																"klasKwetstMetMijnIdentiteit",											ColumnType::Label		),
	...
	new CD("Ik krijg complimenten van docenten",																								"docentenGevenMijComplimenten",											ColumnType::Label		),
