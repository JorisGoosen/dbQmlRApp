...
const ColumnDefinitions SchoolScannerDefinities::_columnDefs =
{
	...
	new CD("Ik voel me onveilig in/op/bij",																										"onveiligHier",															ColumnType::Text    	),
	...
	new CD("Sommige studenten maken vervelende dingen mee in de klas. Hoe komt dit?",															"waaromVervelendeDingenInDeKlas",										ColumnType::Text		),
